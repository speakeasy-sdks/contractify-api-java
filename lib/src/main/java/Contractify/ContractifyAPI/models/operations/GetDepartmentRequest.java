...
public class GetDepartmentRequest {
    ...
    public GetDepartmentRequest withCompany(Long company) {
    ...
    public GetDepartmentRequest withDepartment(Long department) {
        this.department = department;
        return this;
    }
    
    public GetDepartmentRequest(@JsonProperty("company") Long company, @JsonProperty("department") Long department) {
        this.company = company;
        this.department = department;
  }
}
