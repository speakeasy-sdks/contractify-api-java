...
public class ListContractsRequest {
    ...
    public ListContractsRequest withCompany(Long company) {
    ...
    public ListContractsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    
    public ListContractsRequest(@JsonProperty("company") Long company) {
        this.company = company;
  }
}
