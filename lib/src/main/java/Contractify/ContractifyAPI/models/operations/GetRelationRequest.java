...
public class GetRelationRequest {
    ...
    public GetRelationRequest withCompany(Long company) {
    ...
    public GetRelationRequest withRelation(Long relation) {
        this.relation = relation;
        return this;
    }
    
    public GetRelationRequest(@JsonProperty("company") Long company, @JsonProperty("relation") Long relation) {
        this.company = company;
        this.relation = relation;
  }
}
