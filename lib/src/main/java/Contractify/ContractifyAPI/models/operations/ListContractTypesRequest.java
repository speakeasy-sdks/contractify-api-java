...
public class ListContractTypesRequest {
    /**
     * Id of the company
     */
    ...
    public ListContractTypesRequest withCompany(Long company) {
        this.company = company;
        return this;
    }
    
    public ListContractTypesRequest(@JsonProperty("company") Long company) {
        this.company = company;
  }
}
