...
import Contractify.ContractifyAPI.utils.SpeakeasyHTTPClient;
 ...
 */
public class ContractifyProduction {
	/**
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = Contractify.ContractifyAPI.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		 ...
		 */
		public ContractifyProduction build() throws Exception {
			...
			return new ContractifyProduction(this.sdkConfiguration);
		}
	}
	...
	private ContractifyProduction(SDKConfiguration sdkConfiguration) throws Exception {
